...
let of_anomaly_container_five_tuple_flow_metrics_container_parallelized_list_fusion_map
  ...
  Five_tuple_flow_metrics_container.to_list
      ...
      let five_tuple_key_five_tuple_flow_container =
  Five_tuple_key_five_tuple_flow_container.of_five_tuple_flow_metrics_container
    five_tuple_flow_metrics_container
      in
      ...
      let five_tuple_flow_count_hashtable, five_tuple_flow_set_detailed_metrics_tuple_hashtable =
  List.fold_left
          (fun anomaly (count_hashtable, tuple_hashtable)->
            (
    ...
    List.map
      (fun filter_criteria ->
        ...
        | Filter_criteria.Src_ip src_addr ->
          Five_tuple_key_five_tuple_flow_container.find_src_addr
      five_tuple_key_five_tuple_flow_container
      src_addr
        | Filter_criteria.Dst_ip dst_addr ->
          Five_tuple_key_five_tuple_flow_container.find_dst_addr
      five_tuple_key_five_tuple_flow_container
      dst_addr
        | Filter_criteria.Admd_transport_protocol admd_transport_protocol ->
          Five_tuple_key_five_tuple_flow_container.find_admd_transport_protocol
      five_tuple_key_five_tuple_flow_container
      admd_transport_protocol
        | Filter_criteria.Src_port src_port ->
          Five_tuple_key_five_tuple_flow_container.find_src_port
      five_tuple_key_five_tuple_flow_container
      src_port
        | Filter_criteria.Dst_port dst_port ->
          Five_tuple_key_five_tuple_flow_container.find_dst_port
      five_tuple_key_five_tuple_flow_container
      dst_port
      )
    ...
    List.fold_left
      (fun five_tuple_flow_list acc ->
        let set = Five_tuple_flow_set.of_list five_tuple_flow_list in
        Five_tuple_flow_set.inter acc set
      )
      (List.tl five_tuple_flow_list_list)
      (List.hd five_tuple_flow_list_list)
        in
