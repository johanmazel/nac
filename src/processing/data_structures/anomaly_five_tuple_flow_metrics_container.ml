...
let add_packet_ethernet
  ...
  (
    ...
    (*   L.compare *)
    (*     compare *)
    (*     (L.sort compare anomaly_indice_list_reference) *)
    (*     (L.sort compare anomaly_indice_list) *)
    (*   <> *)
    (*   0 *)
    (* then *)
    ...
    (*          (L.to_string string_of_int anomaly_indice_list_reference) *)
    ...
    (* let anomaly_indice_list = anomaly_indice_list_reference in *)
